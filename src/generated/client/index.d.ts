...
export namespace Prisma {
  ...
  */
  ...
  export type SiteContentOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "section" | "content_key" | "content_value" | "updated_at", ExtArgs["result"]["siteContent"]>
  ...
  interface SiteContentFieldRefs {
    readonly id: FieldRef<"SiteContent", 'Int'>
    readonly section: FieldRef<"SiteContent", 'String'>
    readonly content_key: FieldRef<"SiteContent", 'String'>
    readonly content_value: FieldRef<"SiteContent", 'String'>
    readonly updated_at: FieldRef<"SiteContent", 'DateTime'>
  }
  ...
  export type SiteContentWhereInput = {
    ...
    id?: IntFilter<"SiteContent"> | number
    section?: StringFilter<"SiteContent"> | string
    content_key?: StringFilter<"SiteContent"> | string
    content_value?: StringFilter<"SiteContent"> | string
    updated_at?: DateTimeFilter<"SiteContent"> | Date | string
  }

  export type SiteContentOrderByWithRelationInput = {
    id?: SortOrder
    section?: SortOrder
    content_key?: SortOrder
  ...
  export type SiteContentWhereUniqueInput = Prisma.AtLeast<{
    id?: number
    section_content_key?: SiteContentSectionContent_keyCompoundUniqueInput
    AND?: SiteContentWhereInput | SiteContentWhereInput[]
    OR?: SiteContentWhereInput[]
    NOT?: SiteContentWhereInput | SiteContentWhereInput[]
    section?: StringFilter<"SiteContent"> | string
  ...
  export type SiteContentScalarWhereWithAggregatesInput = {
    ...
    id?: IntWithAggregatesFilter<"SiteContent"> | number
    section?: StringWithAggregatesFilter<"SiteContent"> | string
    content_key?: StringWithAggregatesFilter<"SiteContent"> | string
    content_value?: StringWithAggregatesFilter<"SiteContent"> | string
    updated_at?: DateTimeWithAggregatesFilter<"SiteContent"> | Date | string
  }
  ...
  export type SiteContentUpdateInput = {
    ...
    content_key?: StringFieldUpdateOperationsInput | string
  ...
  export type SiteContentSectionContent_keyCompoundUniqueInput = {
    section: string
    content_key: string
  }
