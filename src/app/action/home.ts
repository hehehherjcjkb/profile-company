...
export async function initializeSiteContent() {
            ...
            content_value: JSON.stringify([
                {
                    ...
                    points: ["Kualitas pembelajaran hingga sistem digital", "Koordinasi lebih mudah dan efisien", "Satu tim pendampingan profesional"],
                    icon: "Box",
                    image: ""
                },
                {
                    ...
                    points: ["Dokumen pendukung lengkap", "Format standar dan sistematis", "Siap untuk audit and pelaporan"],
                    icon: "FileText",
                    image: ""
                },
                {
                    ...
                    points: ["Sesuai aturan penggunaan dana pendidikan", "Paket dapat disesuaikan dengan budget", "Transparansi biaya yang jelas"],
                    icon: "Wallet",
                    image: ""
                },
                {
                    ...
                    points: ["Workshop dan pelatihan singkat", "Program tahunan berkelanjutan", "Konsultasi strategis jangka panjang"],
                    icon: "Calendar",
                    image: ""
                },
            ])
    ...
    try {
        for (const item of initialData as SiteContent[]) {
            await prisma.siteContent.upsert({
                where: {
                    section_content_key: {
